...
<div class="card text-center">
  ...
  <div style="background-image:url('admin/images/<?=$_REQUEST['back']?>');height:270px;width:560px">
  <img src="img/<?=$_REQUEST['image']?>" style="padding-top:30px;margin-left:160px;width:210px">
  </div>
