...
<div class="card text-center">
  ...
  <div style="background-image:url('admin/images/<?=$_REQUEST['back']?>');height:270px;width:260px">
  <img src="img/<?=$_REQUEST['image']?>" style="padding-top:90px;margin-left:60px;width:120px">
  </div>
